...
from display_matrix_scroll_text_05 import main

"""
usage: 
cd display_matrix

python -m droneblocks.tello_script_runner --handler display_matrix_scroll_text_user_script_05

python -m droneblocks.tello_script_runner --handler display_matrix_scroll_text_user_script_05 --show-original-video

python -m droneblocks.tello_script_runner --handler display_matrix_scroll_text_user_script_05 --show-original-video --fly
