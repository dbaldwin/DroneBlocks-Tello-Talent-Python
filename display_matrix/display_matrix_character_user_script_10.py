...
from display_matrix_character_09 import main

"""
usage: 
cd display_matrix

python -m droneblocks.tello_script_runner --handler display_matrix_character_user_script_10

python -m droneblocks.tello_script_runner --handler display_matrix_character_user_script_10 --show-original-video

python -m droneblocks.tello_script_runner --handler display_matrix_character_user_script_10 --show-original-video --fly
